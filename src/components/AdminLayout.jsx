...
function AdminLayout({ children }) {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-[#e0e6ea] via-[#e0e6ea] to-[#e0e6ea]">
      <aside className="w-64 bg-[#27548A] text-gray-100 flex flex-col shadow-2xl">
        <div className="h-20 flex flex-col items-center justify-center border-b border-slate-700 p-2 text-center">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <NavLink to="/admin/reports" className={navLinkClasses}>
            {navLinkContent(ReportsIcon, "Reports")}
          </NavLink>
        </nav>
